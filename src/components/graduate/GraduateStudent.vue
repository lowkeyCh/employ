<script>
  export default {
    /**
     * 挂载时获取user信息并以此获取对应user的graduate信息
     */
    mounted() {
      /**
      ...
      this.$axios.get('http://localhost:8081/graduate/query?userId='+ userId).then(res=>{
        ...
        this.graduateModify.graduateAge = res.data.graduateAge
        this.graduateModify.graduateSex = res.data.graduateSex
        this.graduateModify.graduateBirthday = res.data.graduateBirthday
        this.graduateModify.graduateCollege = res.data.graduateCollege
        this.graduateModify.graduateGraduateDate = res.data.graduateGraduateDate
        this.graduateModify.graduateMajor = res.data.graduateMajor
    ...
    methods : {
      ...
      /**
       * 回退到信息卡片 同时重置graduateModify的值
       */
      modifyBack() {
        this.show.showCard = true
        this.show.modifyCard = false

        this.graduateModify.graduateId        = this.graduate.graduateId
        this.graduateModify.graduateName      = this.graduate.graduateName
        this.graduateModify.graduateAge       = this.graduate.graduateAge
        ...
        this.graduateModify.graduateEmail     = this.graduate.graduateEmail
      },

      /**
       * 回到信息卡片
       * 保存修改的信息 同时更新graduate
       */
      modifySave() {
        this.show.showCard = true
        this.show.modifyCard = false

        this.$axios.post('http://localhost:8081/graduate/modify', this.graduateModify).then(res=>{
          this.$message({ message: '修改成功', type: 'success'})

          this.graduate.graduateId       = this.graduateModify.graduateId
          this.graduate.graduateName     = this.graduateModify.graduateName
          this.graduate.graduateAge      = this.graduateModify.graduateAge
          ...
          this.graduate.graduateEmail    = this.graduateModify.graduateEmail
        })
      }
    }
  }
    ...
    <el-card v-show="show.modifyCard">
      <el-descriptions class="margin-top" title="毕业生基本资料" :column="2" border>
        ...
        <el-descriptions-item>
          ...
          <input class="input" type="text" v-model="graduateModify.graduateName">
        </el-descriptions-item>
        ...
        <el-descriptions-item>
          ...
          <input class="input" type="text" v-model="graduateModify.graduateCollege">
        </el-descriptions-item>
        ...
        <el-descriptions-item>
          ...
          <input class="input" type="text" v-model="graduateModify.graduateMajor">
        </el-descriptions-item>
        ...
        <el-descriptions-item>
          ...
          <input class="input" type="text" v-model="graduateModify.graduateAge">
        </el-descriptions-item>
        ...
        <el-descriptions-item>
          ...
          <el-radio v-model="graduateModify.graduateSex" label="男">男</el-radio>
          <el-radio v-model="graduateModify.graduateSex" label="女">女</el-radio>
        </el-descriptions-item>
        ...
        <el-descriptions-item>
          ...
          <input class="input" type="text" v-model="graduateModify.graduateEmail">
        </el-descriptions-item>
        ...
        <el-descriptions-item>
          ...
          <input class="input" type="text" v-model="graduateModify.graduatePhone">
        </el-descriptions-item>
        ...
        <el-descriptions-item>
          ...
          <input class="input" type="date" v-model="graduateModify.graduateBirthday">
        </el-descriptions-item>
        ...
        <el-descriptions-item>
          ...
          <input class="input" type="date" v-model="graduateModify.graduateGraduateDate">
        </el-descriptions-item>
