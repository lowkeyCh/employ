    ...
    export default {
      mounted() {
        ...
        this.$axios.get('http://localhost:8081/enterprise/query_all').then(res=>{
           ...
           */
          // 移除组件
          this.enterpriseListShow = false
          // 在组件移除后，重新渲染组件
          // this.$nextTick可实现在DOM 状态更新后，执行传入的方法。
          this.$nextTick(() => {
            this.enterpriseListShow = true
          })
        })
      },
...
<template>
    <div>
        ...
        >
          ...
          <el-table-column width="300" prop="enterpriseLegalRepresentative">
            <template slot="header">
              ...
              <label style="margin-left: 5px;">法定代表人</label>
            </template>
          </el-table-column>

          <el-table-column width="300" prop="enterpriseCoreBusiness">
            <template slot="header">
              ...
              <label style="margin-left: 5px;">企业主营业务</label>
            </template>
          </el-table-column>
            ...
            <el-table-column>
              <template slot="header">
                ...
                <el-tooltip class="item" effect="dark" content="删除当前企业" placement="top">
